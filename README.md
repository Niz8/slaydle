...
**Weapon Break ⚠️** — Using the same weapon + element combo two turns in a row earns a warning. Use it a third time and your weapon breaks — 0 damage to goblin, -2 HP to you.
...
- Help system added — tap `?` to view rules and patch notes
- Help auto-displays on first load; dismissed with “don’t show again” saved to localStorage
- Returns to patch notes section automatically when a new version is detected
- Reverted crystal ball lock to after turn 1 (beta tested turn 2 lock, reverted)
- Fixed two remaining CSS variable references in scrollbar styles
- README URL updated to main branch
- All URLs confirmed lowercase

### v0.9.2-beta

- Crystal ball lock extended to turn 2 for beta testing only
...
- Version number added to footer
